...
Pais::Pais(const char *codigo, const char *codigo2, const char *nombre,const char *continente, float superficie, int poblacion,short independencia, float expectativa, int IDCapital){
    strcpy(_codigo,codigo);
    strcpy(_codigo2,codigo2);
    strcpy(_nombre,_nombre);
    strcpy(_continente,continente);
    _superficie=superficie;
    _poblacion=poblacion;
    _independencia=independencia;

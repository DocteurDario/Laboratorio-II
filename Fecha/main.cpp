...
Hacer una clase Fecha que permita generar objetos capaces de almacenar fechas y hacer operaciones con las mismas. La clase en ningún
 momento debe almacenar una fecha inválida. Es decir, una fecha que no exista en el calendario.
...
int main()
{
    Fecha fecha(1,9,2023);
    cout << fecha.toString("YYYY/MM/DD")<<endl;
    cout << fecha.toString("DD/MM/YYYY")<<endl;
    return 0;
}
